...
|----------|-------|-------------|
| Troubleshooting | L31-L58 | Diagnosing and fixing Durable Functions/Task SDK issues, AZFD/AZFW error codes, storage and config problems, and runtime/deployment errors for Node.js, Python, and VM start/stop functions. |
| Best Practices | L60-L89 | Patterns and guidance for robust, performant Azure Functions and Durable Functions: orchestration/entity design, versioning, error handling, DI, HTTP/connection usage, scaling, and language-specific best practices. |
| Decision Making | L91-L118 | Guidance on choosing Functions hosting/scaling plans, estimating costs, networking/isolation, language/runtime lifecycles, and migrating or upgrading Functions and Durable Functions apps. |
| Architecture & Design Patterns | L120-L125 | Running Functions in Linux containers, Durable Functions design with Azure Storage, and hosting Functions on Azure Container Apps for scalable, container-based architectures. |
| Limits & Quotas | L127-L135 | Limits, quotas, and configuration for Azure Functions scale, concurrency, throughput, large payloads in Durable Task, and supported languages/runtime versions. |
| Security | L137-L153 | Securing Functions apps: encryption at rest, storage and endpoint access, private networking, managed identities for triggers/bindings/SQL, roles, and Web PubSub/MCP security. |
| Configuration | L155-L194 | Configuring Azure Functions apps: bindings, host/app settings, plans, networking, tracing/monitoring, Durable Functions, Core Tools/local dev, runtime versions, and run-from-package setup. |
| Integrations & Coding Patterns | L196-L305 | Patterns and how-tos for wiring Functions to external systems (HTTP, data stores, messaging, AI/OpenAI, Dapr, MCP, APIs) using triggers/bindings and integration-specific configs. |
| Deployment | L307-L342 | Deploying and updating Azure Functions: provisioning hosting (ARM/Bicep/Terraform), containers/Kubernetes/Container Apps, CI/CD (GitHub/Azure Pipelines), scaling, zero‑downtime, and migration tasks. |
